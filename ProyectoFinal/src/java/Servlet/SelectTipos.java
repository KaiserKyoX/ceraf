 ...
 * @author cclavijo
 */
public class SelectTipos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<ModeloEspacios> res = new ArrayList<ModeloEspacios>();
            
            EspaciosBD espacio = new EspaciosBD();
            
            
            res=(ArrayList<ModeloEspacios>) espacio.selectClientes();
